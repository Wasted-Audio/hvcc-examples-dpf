...
There are two versions, one with a Dear ImGui UI using basic widgets and one using NanoVG with a converted [plugdata](https://plugdata.org/) UI.
...
![Simple Delay NanoVG](delay_simple_nanovg.png)
